...
typedef struct malloc_state*    mstate; // TODO
...
static struct malloc_params mparams; // TODO
...
static struct malloc_state _gm_; // TODO
#define gm                 (&_gm_)
...
int malloc_corruption_error_count; // TODO
