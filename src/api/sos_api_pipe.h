...
error_t sos_close_pipe(sos_pipe_t pipe) TINKER_API_SUFFIX;

error_t sos_delete_pipe(sos_pipe_t pipe) TINKER_API_SUFFIX;
...
error_t sos_received_message(sos_pipe_t pipe) TINKER_API_SUFFIX;
